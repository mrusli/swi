...
@Entity
@Table(name = "transfer_material", schema = SchemaUtil.SCHEMA_COMMON)
public class InventoryTransferMaterial extends IdBasedObject {

	/**
	 * 
	 */
	private static final long serialVersionUID = -9051996987293431949L;
	...
	@JoinTable(name = "transfer_join_transfer_material",
			joinColumns = @JoinColumn(name = "id_transfer_material"),
	...
	public String toString() {
		...
		return "InventoryTransferMaterial[id="+getId()+
				", marking="+getMarking()+
