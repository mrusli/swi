...
@Entity
@Table(name = "voucher_payment_debitcredit", schema=SchemaUtil.SCHEMA_COMMON)
public class VoucherPaymentDebitCredit extends IdBasedObject {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6278035608165679276L;
	...
	public String toString() {
		...
		return "VoucherPaymentDebitCredit[id="+getId()+
