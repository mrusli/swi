...
@Entity
@Table(name = "voucher_sales_debitcredit", schema = SchemaUtil.SCHEMA_COMMON)
public class VoucherSalesDebitCredit extends IdBasedObject {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5040134040444284056L;
	...
	public String toString() {
		...
		return "VoucherSalesDebitCredit[id="+getId()+
